## NASA Lunar Autonomy Challenge IPEx Code
...
The NASA Lunar Autonomy Challenge was a competition to develop a fully autonomous agent to map and navigate an unknown lunar environment. The challenge emulates NASA priorities in robotic exploration as we explore the lunar south pole in the Artemis missions. The agent is judged by its capacity to generate a geometric map of ground height, rock map, mapping productivity, and localization abilities in the partially occluded visual conditions. The challenge website can be found here: [NASA Lunar Autonomy Challenge Home](https://lunar-autonomy-challenge.jhuapl.edu/).
